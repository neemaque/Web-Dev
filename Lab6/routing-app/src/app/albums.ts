...
export let ids = 100;
export function change_title(album: Album, new_title: string)
{
  album.title = new_title;
}
export function create_album(title: string)
{
  ids += 1;
  albums.push({
    "userId": 1,
...
export function delete_album(title: string)
{
  albums = albums.filter(x => x.title != title);
}
export let albums =
  [
    {
